...
public class TankTrackController : MonoBehaviour
{
	...
	{ //5
		...
		leftTrack.GetComponent<Renderer>().material.SetTextureOffset("_MainTex", new Vector2(0, leftTrackTextureOffset)); // -leftTrackTextureOffset
		...
		rightTrack.GetComponent<Renderer>().material.SetTextureOffset("_MainTex", new Vector2(0, rightTrackTextureOffset)); // -rightTrackTextureOffset
